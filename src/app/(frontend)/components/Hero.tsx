...
const Hero = () => {
  return (
    <header className="relative w-full h-screen flex flex-col items-center justify-center text-center text-white bg-cover bg-center">
      {/* Background Image */}
      <Image
        src={backgroundHero}
        alt="Hero Background"
      ...
      <div className="relative z-10 max-w-2xl">
        {/* Animated Heading */}
        <motion.h1
          className="text-4xl font-bold mb-[50px] text-[74px]"
        ...
        <p className="text-[18px] text-[#C0C0C0] tracking-wider mb-[30px]">
