...
const AboutSection = () => {
  ...
  return (
    ...
    >
      ...
      {/* Content Wrapper */}
      <div className="relative z-10 w-full max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-2 items-center gap-y-10 gap-x-6 md:gap-x-12 text-center md:text-left">
              ...
              {['Expert Guidance', 'Wide Selection of Properties', 'Seamless Buying Process'].map(
                (item, index) => (
                  <div key={index} className="flex items-center justify-start gap-3">
                    <Image src={correct} width={15} height={15} alt="correct" />
