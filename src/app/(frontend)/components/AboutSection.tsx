...
const AboutSection = () => {
  ...
  return (
    <section className="relative w-full h-[500px] flex items-center justify-center overflow-hidden flex-col">
      {/* Parallax Background */}
      <div
      ...
      <div
        className="absolute inset-y-0 right-0 w-[58rem] h-full"
        style={{
      ...
      {/* Content Section */}
      <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col items-end px-6 md:px-2 text-white">
        <div className="max-w-2xl text-left">
          ...
          <h2 className="text-3xl md:text-4xl font-semibold mt-4">About PB Realty Services</h2>
          <p className="mt-4 w-full max-w-[60rem] md:max-w-[45rem] lg:max-w-[50rem] xl:max-w-[60rem] text-[15px] leading-relaxed text-[#E0E0E0]">
          ...
          <div className="relative z-10 mt-[20px] flex justify-start">
            {' '}
